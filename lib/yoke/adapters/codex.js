...
// "openai.gpt-5.5"). This is driven by the `codexBedrock` flag in the Clay
...
// On AWS Bedrock, Codex model IDs must be prefixed with "openai." (e.g.
// "openai.gpt-5.5"). Upstream keeps a bare-string CODEX_MODELS list; we apply
...
var DEFAULT_CODEX_MODEL = codexModelId("gpt-5.5");
var FALLBACK_CODEX_MODELS = [
  { value: DEFAULT_CODEX_MODEL, displayName: "gpt-5.5", supportsEffort: true, supportedEffortLevels: ["minimal", "low", "medium", "high"] },
];
...
function createCodexAdapter(opts) {
  ...
  var adapter = {
    ...
    supportedModels: function() {
      ...
      return Promise.resolve(CODEX_MODELS.map(codexModelId));
    },
